...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-bg-surface transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-accent-subtle/40 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-bg-elevated data-[state=open]:text-text-muted min-h-[32px] min-w-[32px] flex items-center justify-center cursor-pointer">
        <X className="h-4 w-4" />
